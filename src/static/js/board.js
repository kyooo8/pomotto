...
var Board = () => {
  ...
  useEffect(() => {
    ...
    fetchApi();
    const intervalId = setInterval(fetchApi, 5e3);
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, {
    children: data.map((d) => {
      ...
      const statusColor = d.status === "FOCUS" ? "bg-red-100 text-red-800" : d.status === "BREAK" ? "bg-blue-100 text-blue-800" : "bg-green-100 text-green-800";
      return /* @__PURE__ */ jsxDEV("tr", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV("td", {
            class: "px-4 py-2",
            children: d.status === "FOCUS" ? "\u{1F7E5} \u4F5C\u696D\u4E2D" : d.status === "BREAK" ? "\u{1F7E6} \u4F11\u61A9\u4E2D" : "\u{1F7E9} \u672A\u4F7F\u7528"
          }),
          /* @__PURE__ */ jsxDEV("td", {
            class: "px-4 py-2 font-mono tabular-nums text-right",
            children: [
          ...
          /* @__PURE__ */ jsxDEV("td", {
            ...
            children: new Date(d.updatedAt).toLocaleTimeString()
          })
        ]
      }, d.seatId);
    })
...
render(/* @__PURE__ */ jsxDEV(Board, {}), el);
